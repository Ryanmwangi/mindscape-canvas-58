...
const appCss = "/mindscape-canvas-58/assets/styles-Dh_KO998.css";
...
const Route$3 = createRootRouteWithContext()({
  head: () => ({
    meta: [
      ...
      { title: "HisMind Creatives — Digital Presence & Strategy" },
      { name: "description", content: "HisMind Creatives is a digital strategy and creative communications agency helping brands grow through content, storytelling and discoverability." },
      { name: "author", content: "HisMind Creatives" },
      { property: "og:title", content: "HisMind Creatives — Digital Presence & Strategy" },
      { property: "og:description", content: "Brand strategy, digital marketing, content and web design for growing brands." },
...
const $$splitComponentImporter$2 = () => import("./index-m3D2jPwd.js");
const Route$2 = createFileRoute("/")({
  component: lazyRouteComponent($$splitComponentImporter$2, "component")
});
const $$splitComponentImporter$1 = () => import("./blog.social-vs-seo-discovery-DuKs5MUy.js");
const Route$1 = createFileRoute("/blog/social-vs-seo-discovery")({
  head: () => ({
    meta: [{
      title: "Is social media taking over discovery? — HisMind Creatives"
    }, {
      name: "description",
      content: "Discovery doesn't begin with Google anymore. How search behaviour has shifted to social, and what brands must do about it."
    }, {
      property: "og:title",
      content: "Is social media taking over discovery? — HisMind Creatives"
    }, {
      property: "og:description",
      content: "The rules of discoverability have changed. Build content for searches, not just feeds."
    }, {
      property: "og:image",
      content: "/og-discovery.jpg"
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$1, "component")
});
const $$splitComponentImporter = () => import("./blog.marketing-vs-advertising-ywJUV-Sp.js");
const Route2 = createFileRoute("/blog/marketing-vs-advertising")({
  head: () => ({
    meta: [{
      title: "Marketing vs Advertising — HisMind Creatives"
    }, {
      name: "description",
      content: "What's the difference between marketing and advertising? A look at strategy, story and the work that happens under the surface."
    }, {
      property: "og:title",
      content: "Marketing vs Advertising — HisMind Creatives"
    }, {
      property: "og:description",
      content: "Strategy builds the house. Advertising paints the walls."
    }, {
      property: "og:image",
      content: "/og-marketing.jpg"
    }]
  }),
...
const BlogSocialVsSeoDiscoveryRoute = Route$1.update({
  id: "/blog/social-vs-seo-discovery",
  path: "/blog/social-vs-seo-discovery",
  getParentRoute: () => Route$3
});
const BlogMarketingVsAdvertisingRoute = Route2.update({
...
const rootRouteChildren = {
  IndexRoute,
  BlogMarketingVsAdvertisingRoute,
  BlogSocialVsSeoDiscoveryRoute
};
