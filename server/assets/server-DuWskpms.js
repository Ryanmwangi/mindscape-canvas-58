...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("./_tanstack-start-manifest_v-DJX4OlYC.js");
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-BjaB4-iy.js").then((n2) => n2.r),
    import("./start-D5DH_pIf.js"),
...
var ROUTER_BASEPATH = "mindscape-canvas-58";
var SERVER_FN_BASE = "/mindscape-canvas-58/_serverFn/";
